<template>
  <SubRoot>
    ...
    <div class="subInner window">
          ...
          <BaseTable>
            ...
            <tbody>
              <tr class="trBlue">
                ...
                <td class="text-center">완산구</td>
                <td class="text-center">
                  <p class="tableData">000000000</p>
                  <p class="tableData">000000000</p>
                </td>
                <td class="text-center">고가도</td>
                <td class="text-center">현행화접수</td>
                <td class="text-center">2024-07-25</td>
                <td class="text-center">-</td>
                <td class="text-center">전라북도 완산구 111</td>
                <td class="text-center">전라북도 완산구 222</td>
              </tr>
              <tr>
                ...
                <td class="text-center">지하도</td>
                <td class="text-center">현행화접수</td>
                <td class="text-center">2024-07-19</td>
                <td class="text-center">-</td>
                <td class="text-center">전라북도 완산구 333</td>
                <td class="text-center">전라북도 완산구 555</td>
              </tr>
              <tr>
                ...
                <td class="text-center">서울특별시 강북구 666</td>
                <td class="text-center">서울특별시 강북구 777</td>
              </tr>
            </tbody>
          </BaseTable>
      ...
      <section class="sectionContainer">
        <div class="sectionBox">
          <SectionTitle title="성과물파일" :right="right">
            <template v-slot:right>
              <BaseButton
                label="다운로드"
          ...
          <BaseTable styleClassName="overflow-y">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center">1</td>
                <td class="text-center">1</td>
                <td class="text-center">성과물 도로구간(공간정보)</td>
              </tr>
              <tr>
                <td class="text-center">
                ...
                <td class="text-center">2</td>
                <td class="text-center">1</td>
                <td class="text-center">성과물 실폭도로(공간정보)</td>
              </tr>
              <tr>
                <td class="text-center">
                ...
                <td class="text-center">3</td>
                <td class="text-center">1</td>
                <td class="text-center">성과물 수직연결점(공간정보)</td>
              </tr>
              <tr>
                <td class="text-center">
                ...
                <td class="text-center">1</td>
                <td class="text-center">성과물 수직이동통로(공간정보)</td>
              </tr>
              <tr>
                <td class="text-center">
                ...
                <td class="text-center">1</td>
                <td class="text-center">성과물 교차면(공간정보)</td>
              </tr>
              <tr>
                <td class="text-center">
                ...
                <td class="text-center">-</td>
                <td class="text-center">성과물 구조물의 범위(공간정보)</td>
              </tr>
              <tr>
                <td class="text-center">
              ...
              <tr>
                <td class="text-center">
                  <BaseCheckbox id="check9" />
                </td>
                <td class="text-center">8</td>
                <td class="text-center">3</td>
                <td class="text-center">신청 현황도</td>
              </tr>
              <tr>
                <td class="text-center">
                  <BaseCheckbox id="check10" />
                </td>
          ...
          <BaseTable>
            ...
            <tbody>
              <tr>
                <td class="text-center">1</td>
                <td class="text-center">
                  <p class="tableData">0000000000</p>
                  <p class="tableData">0000000000</p>
                </td>
              ...
              <tr>
                ...
                <td class="text-center">신청물수와 성과물수 불일치</td>
                <td class="text-left">일치시키기 바랍니다.</td>
        ...
        <div class="sectionBox">
          ...
          <BaseTable>
            ...
            <tbody>
              <tr>
                <td class="text-center">1</td>
                <td class="text-center">000000000000</td>
                <td class="text-center">전라북도_2948_manage1</td>
                <td class="text-center">JPG</td>
                <td class="text-center">
                  <BaseButton
                    label="미리보기"
                    styleClassName="md pd-sm bdGray i-search"
                    text-
                  />
                </td>
              </tr>
              <tr>
                <td class="text-center">2</td>
                <td class="text-center">000000000000</td>
                <td class="text-center">전라북도_2948_manage2</td>
