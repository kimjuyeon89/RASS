<template>
  <Popup :maxWidth="860" :visible="popupVisible" class="fixed">
    <SectionTitle
      title="공지사항 등록"
      titleIcon="megaphone-blue"
      @close="popupVisible = false"
    />

    <PopupSectionBody>
      <BaseTable class="rowType" :caption="caption">
        <colgroup>
        ...
        <tbody>
          ...
          <tr>
            <th scope="row" class="text-center">공지 시작일</th>
            <td class="text-center">
              <BaseInput inputType="date" styleClassName="hasCalendar">
            ...
            <th scope="row" class="text-center">공지 종료일</th>
            <td class="text-center">
              <BaseInput inputType="date" styleClassName="hasCalendar">
                <template v-slot:prepend>
                  <button type="button" class="btnCalendar">
          ...
          <tr>
            ...
            <td colspan="3">
              <BaseTextarea inlineStyle="height: 180px" />
            </td>
          </tr>
          <tr>
            <th scope="row" class="text-center">첨부파일</th>
            <td class="tdHasTable" colspan="3">
              <div class="tableBox col hasTable">
                <div class="rowTableItem btnWd90">
                ...
                <BaseTable>
                  ...
                  <thead>
                    <tr>
                      <th scope="col">
                        <BaseCheckbox id="check1" styleClassName="sm" />
                      </th>
                  ...
                  <tbody>
                    <tr>
                      <td class="text-center">
                        <BaseCheckbox id="check2" styleClassName="sm" />
                      </td>
          ...
          <tr>
            <th scope="row" class="text-center">도배방지확인</th>
            <td colspan="3">
              <div class="securityArea">
                <div class="numberBox tableBoxItem">
                  <BaseInput inputType="text" inputValue="916245" readonly />
                </div>
                ...
                <div class="tableBox">
                  <BaseInput
                    ...
                    styleClassName="securityInput"
                  />
                  <BaseButton
                    label="새로고침"
                    styleClassName="md pd-sm bdGray i-refresh"
                  />
                  <BaseButton label="확인" styleClassName="md pd-sm bdGray" />
                </div>
              </div>
            </td>
          </tr>
...
const caption = {
  name: '공지사항 등록',
  cell: '제목,공지시작일,공지종료일,내용,첨부파일,도배방지 확인',
}
